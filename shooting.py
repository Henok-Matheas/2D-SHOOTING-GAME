...
def draw(user_group, enemy_group, keys_pressed, user_bullets, enemy_bullets, target):
    ...
    for user in user_group:
        ...
        enemy_group.update(targt, WIDTH, HEIGHT, SHOOTING_RADIUS)
...
async def loadBullets(enemy,rot, enemy_bullets ):
    enemy_bullets.append(Bullet(enemy.rect.centerx, enemy.rect.centery, rot, BULLET_VEL, BULLET_WIDTH, BULLET_HEIGHT))
